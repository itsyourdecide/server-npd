...
> **ARCHIVED / COMPLETED POC.** Файл сохраняет исходную лабораторную схему и
> acceptance criteria. Он не является источником текущего состояния. Актуальные
> VLAN временно сведены в [current state](../../../docs/current-state.md).
