...
> **ARCHIVED / SUPERSEDED.** Документ смешивает исходный план, выполненные
> milestones и устаревшие открытые вопросы. Актуальное состояние находится в
> [current state](../../../docs/current-state.md), сервисные инструкции — в
> `docs/services/`.
