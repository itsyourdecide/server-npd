...
- Статус: current runbook; вариант B не испытан
- Последний тест: вариант A выполнен 2026-07-08
- Impact: вариант B вызывает короткий outage routing/firewall
- Источник истины для: контролируемого migration/replica failover `fw01`
