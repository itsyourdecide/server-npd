...
- Статус: current user-facing instruction
- Последняя проверка workflow: 2026-08-28
- Аудитория: первые тестовые пользователи
- Источник истины для: краткой инструкции подключения и отправки первой задачи
