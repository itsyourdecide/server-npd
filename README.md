...
4. [План пользовательской платформы](docs/project/user-platform-plan.md) —
   продуктовые границы, MVP и этапы развития портала.
5. [Технический план пользовательской
   платформы](docs/project/user-platform-implementation-plan.md) — архитектура
   реализации, интеграции и пакеты технических работ.
6. [Правила документации](docs/documentation-guide.md) — куда и как вносить
   изменения, чтобы не создавать новые источники истины.
7. [План реорганизации](docs/documentation-reorganization-plan.md) — принятая
